...
This module is responsible for evaluating the differences in handball
match events based on various approaches. It processes CSV files
containing event data and calculates the accuracy of different methods
in predicting event phases.

The main functionalities include:
- Generating file paths dynamically based on inputs.
- Initializing dataframes from Excel and JSON files.
- Processing CSV data for different methods and updating the main
dataframe.
- Evaluating the accuracy of different approaches and saving the
results to CSV files.

The module uses pandas for data manipulation and JSON for reading
event timelines

author: Annabelle Runge
date: 01.04.2025
