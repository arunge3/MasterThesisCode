...
# floodlight_code.plot_phases(23400307, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400307, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400307, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400307, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400277, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400277, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400277, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400277, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400267, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400267, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400267, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400267, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400319, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400319, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400319, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400319, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400311, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400311, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400311, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400311, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400321, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400321, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400321, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400321, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400303, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400303, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400303, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400303, dv.Approach.COST_BASED_RB)
...
# floodlight_code.plot_phases(23400315, dv.Approach.POS_RB)
# floodlight_code.plot_phases(23400315, dv.Approach.COST_BASED)
# floodlight_code.plot_phases(23400315, dv.Approach.COST_BASED_COR)
# floodlight_code.plot_phases(23400315, dv.Approach.COST_BASED_RB)
