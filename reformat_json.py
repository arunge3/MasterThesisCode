...
Modules:
    helpFunctions.reformatJson_Methods: Contains helper functions for reformatting JSON data.
Constants:
...
Functions:
    helpFuctions.get_paths_by_match_id(match_id):
        ...
        Args:
            match_id (int): Unique identifier for the match.
        Returns:
            tuple: Contains paths for video, timeline, output JSONL, position file, cut height, offset, and first video height.
